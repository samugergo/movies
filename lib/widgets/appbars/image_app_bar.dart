    ...
    return LayoutBuilder(builder: (BuildContext layoutCtx, BoxConstraints constraints) {
      ...
      children.add(!onlyTitle
          ? Positioned(
              ...
              child:
                  Opacity(opacity: 1 - (shrinkOffset / maxExtent * 2).clamp(0, 1.0), child: child))
          : SizedBox());
      ...
      return Container(
          decoration: BoxDecoration(color: color!.withAlpha(10), boxShadow: <BoxShadow>[
            BoxShadow(color: color!, blurRadius: 1, offset: Offset(0, 2))
          ]),
    ...
    return ShaderMask(
        ...
        child: Container(
            decoration: cover != null
                ? BoxDecoration(image: DecorationImage(image: cover!.image, fit: BoxFit.cover))
