...
class _ResultListState extends State<ResultList> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(shrinkWrap: true, controller: widget._controller, children: [
      SizedBox(height: 20),
      Padding(
...
class HistoryList extends StatelessWidget {
  ...
  _onTap(int index) {
    _controller.value = TextEditingValue(
        text: _history[index],
        selection: TextSelection.fromPosition(TextPosition(offset: _history[index].length)));
    ...
    return Container(
        ...
        child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return ListTile(
                  onTap: () => _onTap(index),
                  leading: Icon(Icons.schedule, color: Colors.white60),
                  title: Text(_history[index],
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      style: TextStyle(color: Colors.white60, fontWeight: FontWeight.normal)),
                  trailing: IconButton(
                      icon: Icon(Icons.cancel, color: Colors.white12, size: 18),
    ...
    return Center(
        child: Padding(
            ...
            child: Column(
                ...
                children: [
                  Icon(Icons.search_off_outlined, color: Colors.grey, size: 100),
                  Wrap(children: [
                    Text(locale.noResult,
                        style: TextStyle(
